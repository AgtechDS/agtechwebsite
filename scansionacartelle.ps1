...
$cartellaDiPartenza = "E:\AGTECH\WebSite\agtech-digital-hub-main"
$fileOutput = "E:\AGTECH\WebSite\agtech-digital-hub-main\struttura_cartelle_e_file.txt"

# Cartelle da escludere
$cartelleDaEscludere = @("node_modules", "AI", "chat", "Lib", ".git", ".expo", "documentazione")
